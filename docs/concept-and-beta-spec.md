...
| 公開ミント | 700 NFT（70%） |
| リザーブ枠 | 300 NFT（30%）— 1年ロック後配布 |
| ミント価格 | 0.040798 ETH（= Total Raise / 1,000） |
...
| 枠 | 数量 | 説明 |
|----|------|------|
| 公開ミント | 700 NFT (70%) | mintページで一般販売 |
| リザーブ枠 | 300 NFT (30%) | 1年ロック後に配布（詳細は別途設計） |

**Total Raise = Underlying Asset Value（40.798 ETH）** として設計。
公開ミントからの収益：700 × 0.040798 = **28.5586 ETH**

- リザーブ枠は `ownerMint` 関数でオーナーが任意のアドレスに配布可能
- 提供者は盆栽の評価額に応じた比例配分
...
**NFTセール**：
- Total Raise = Underlying Asset Value = 40.798 ETH
- 公開ミント: 700 NFT × 0.040798 ETH = 28.5586 ETH
- リザーブ枠: 300 NFT（1年ロック後配布）

**年間運用想定**：
- レンタル収益 100万円/年 → Vault還元30% = 30万円 → バイバック原資
- 仮にVault NFT市場価格が0.04 ETHのまま → 約30枚をバイバック＆バーン
